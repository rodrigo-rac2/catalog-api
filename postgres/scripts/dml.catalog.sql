-- Inserting roles
insert into roles (description) values ('Autor'), ('Tradutor'), ('Editor');

-- Inserting participants (autores e tradutores)
...
-- Technical books on Python and PostgreSQL
insert into books (title, description, editionnumber, publisher, publicationplace, publicationdate, numberofpages, isbn) values
...
-- Inserting relations BookParticipants (assuming roles and participants inserted above)
